...
for (i, r) in enumerate(rs)
    ...
    if i>1
        ...
        ax.text(0.15, 0.875, "\$f^{(2)}\$"; color = "C2", transform = ax.transAxes, size = 32)
    end
    ax.plot(cx, cy; lw = 1.0, color = "C0")
    ax.text(0.05, 0.875, "\$f\$"; color = "C1", transform = ax.transAxes, size = 32)
end
